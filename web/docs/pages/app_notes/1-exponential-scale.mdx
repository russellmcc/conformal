...
import changingc_img from "../../src/images/app-notes/1/changingc.gif";
import fixedp_img from "../../src/images/app-notes/1/fixedp.gif";
import varp_img from "../../src/images/app-notes/1/varp.gif";
...
<Image src={changingc_img} alt="plot with changing c" />
...
<Image src={fixedp_img} alt="plot with changing q" />
...
<Image src={varp_img} alt="plot with changing p and q" />
