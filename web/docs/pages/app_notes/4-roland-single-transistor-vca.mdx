...
import circuit_img from "../../src/images/app-notes/4/circuit.png";
import simplified_img from "../../src/images/app-notes/4/simplified.png";
import spice_circuit_img from "../../src/images/app-notes/4/spice-circuit.png";
import spice_vbc_vs_vin_img from "../../src/images/app-notes/4/spice_vbc_vs_vin.png";
import spice_ie_vs_vin_img from "../../src/images/app-notes/4/spice_ie_vs_vin.png";
import spice_vbc_vs_vcontrol_img from "../../src/images/app-notes/4/spice_vbc_vs_vcontrol.png";
import spice_vca_img from "../../src/images/app-notes/4/spice_vca.png";
import spice_ie_vs_vcontrol_img from "../../src/images/app-notes/4/spice_ie_vs_vcontrol.png";
...
<Image src={circuit_img} alt="Single-transistor VCA circuit" />
...
<Image src={simplified_img} alt="Single-transistor VCA circuit" />
...
<Image src={spice_circuit_img} alt="Spice circuit" />
...
<Image src={spice_vbc_vs_vin_img} alt="Vbc vs Vin" />
...
<Image src={spice_ie_vs_vin_img} alt="Ie vs Vin" />
...
<Image src={spice_vbc_vs_vcontrol_img} alt="Vbc vs Control" />
...
<Image src={spice_ie_vs_vcontrol_img} alt="Ie vs Control" />
...
<Image src={spice_vca_img} alt="Vca" />
