...
import smoothing_img from "../../src/images/app-notes/2/smoothing.png";
import smoothing2_img from "../../src/images/app-notes/2/smoothing2.png";
...
<Image src={smoothing_img} alt="Effect of smoothing delay time" />
...
<Image src={smoothing2_img} alt="recursive smoothing time" />
