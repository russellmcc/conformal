...
import polyblit0_img from "../../src/images/app-notes/3/polyblit-0.png";
import polyblit1_img from "../../src/images/app-notes/3/polyblit-1.png";
import polyblep0_img from "../../src/images/app-notes/3/polyblep-0.png";
import polyblep1_img from "../../src/images/app-notes/3/polyblep-1.png";
import polyblep1res_img from "../../src/images/app-notes/3/polyblep-1-residual.png";
import polyblep2_img from "../../src/images/app-notes/3/polyblep-2.png";
import polyblep2res_img from "../../src/images/app-notes/3/polyblep-2-residual.png";
import polyblamp1_img from "../../src/images/app-notes/3/polyblamp-1.png";
import polyblamp2_img from "../../src/images/app-notes/3/polyblamp-2.png";
import polyblamp2res_img from "../../src/images/app-notes/3/polyblamp-2-residual.png";
import polyblamp3_img from "../../src/images/app-notes/3/polyblamp-3.png";
import polyblamp3res_img from "../../src/images/app-notes/3/polyblamp-3-residual.png";
...
<Image src={polyblit0_img} alt="0-order polyBLIT" />
...
<Image src={polyblit1_img} alt="1-order polyBLIT" />
...
<Image src={polyblep0_img} alt="0-order polyBLEP" />
...
<Image src={polyblep1_img} alt="1-order polyBLEP" />
...
<Image src={polyblep1res_img} alt="1-order polyBLEP residual" />
...
<Image src={polyblep2_img} alt="2-order polyBLEP" />
...
<Image src={polyblep2res_img} alt="2-order polyBLEP residual" />
...
<Image src={polyblamp1_img} alt="1-order polyBLAMP" />
...
<Image src={polyblamp2_img} alt="2-order polyBLAMP" />
...
<Image src={polyblamp2res_img} alt="2-order polyBLAMP residual" />
...
<Image src={polyblamp3_img} alt="3-order polyBLAMP" />
...
<Image src={polyblamp3res_img} alt="3-order polyBLAMP residual" />
