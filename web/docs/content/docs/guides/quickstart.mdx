...
[`bun`](https://bun.sh) is the TypeScript runtime we use for all build tooling in Conformal. Please follow installation instructions [on their website](https://bun.com/docs/installation#macos-%26-linux)
...
```sh copy
echo "VST3_SDK_DIR=$HOME/SDKs/vst3sdk" > .env # if you installed the SDK
bun install
bun run bootstrap
```
